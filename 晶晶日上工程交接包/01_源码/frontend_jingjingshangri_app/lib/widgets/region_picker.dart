...
class RegionPicker extends StatefulWidget {
  ...
  /// 显示地区选择器，返回 [province, city, district]
...
class _RegionPickerState extends State<RegionPicker> {
  int _currentLevel = 0; // 0=省 1=市 2=区县
  String? _province;
  String? _city;
  String? _district;
  ...
  void initState() {
    ...
    if (_province != null) _currentLevel = 1;
    if (_city != null) _currentLevel = 2;
  }
      ...
      builder: (context, scrollController) => Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Text('选择地区', style: TextStyle(color: AppTheme.lightGold, fontSize: 16, fontWeight: FontWeight.bold)),
                TextButton(
                  onPressed: _province != null && _city != null && _district != null
                      ? () => Navigator.pop(context, [_province!, _city!, _district!])
                      : null,
                  child: const Text('确定', style: TextStyle(color: AppTheme.gold)),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                _levelChip('省份', _province, 0),
                const Icon(Icons.chevron_right, color: AppTheme.textHint, size: 16),
                _levelChip('城市', _city, 1),
                const Icon(Icons.chevron_right, color: AppTheme.textHint, size: 16),
                _levelChip('区县', _district, 2),
              ],
            ),
          ),
          ...
          Expanded(
            child: _currentLevel == 0
                ? _buildList(_regionData.keys.toList(), _province, (v) {
                    setState(() {
                      _province = v;
                      _city = null;
                      _district = null;
                ...
                : _currentLevel == 1
                    ? _buildList(
                        _regionData[_province]?.keys.toList() ?? [],
                        _city,
                        (v) {
                          setState(() {
                            _city = v;
  ...
  Widget _levelChip(String label, String? value, int level) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isCurrent ? AppTheme.gold : Colors.transparent),
        ),
        child: Text(
          value ?? label,
          style: TextStyle(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return ListTile(
          ...
          trailing: isSelected ? const Icon(Icons.check, color: AppTheme.gold, size: 18) : null,
          onTap: () => onTap(item),
        );
      },
    );
...
/// 省市区数据（主要省市，覆盖全国34个省级行政区）
const Map<String, Map<String, List<String>>> _regionData = {
  '北京': {
    '北京市': ['东城区', '西城区', '朝阳区', '海淀区', '丰台区', '石景山区', '通州区', '顺义区', '昌平区', '大兴区', '房山区', '门头沟区', '平谷区', '怀柔区', '密云区', '延庆区'],
  },
  '上海': {
  ...
  '重庆': {
    '重庆市': ['渝中区', '江北区', '南岸区', '九龙坡区', '沙坪坝区', '大渡口区', '渝北区', '巴南区', '北碚区', '万州区', '涪陵区', '永川区', '合川区', '江津区', '长寿区', '黔江区'],
  },
  '广东': {
    '广州市': ['越秀区', '海珠区', '荔湾区', '天河区', '白云区', '黄埔区', '番禺区', '花都区', '南沙区', '增城区', '从化区'],
    '深圳市': ['福田区', '罗湖区', '南山区', '宝安区', '龙岗区', '盐田区', '龙华区', '坪山区', '光明区', '大鹏新区'],
    '东莞市': ['莞城街道', '南城街道', '东城街道', '万江街道', '虎门镇', '长安镇', '厚街镇', '塘厦镇', '常平镇', '松山湖'],
    '佛山市': ['禅城区', '南海区', '顺德区', '三水区', '高明区'],
    '珠海市': ['香洲区', '斗门区', '金湾区'],
    '中山市': ['石岐街道', '东区街道', '西区街道', '南区街道', '小榄镇', '古镇镇', '三乡镇'],
  ...
  '河南': {
    ...
    '平顶山市': ['新华区', '卫东区', '石龙区', '湛河区', '宝丰县', '叶县', '鲁山县', '舞钢市', '汝州市'],
  ...
  '贵州': {
    ...
    '毕节市': ['七星关区', '大方区', '黔西市', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县'],
    ...
    '黔西南布依族苗族自治州': ['兴义市', '兴仁市', '贞丰县', '望谟县', '册亨县', '晴隆县', '普安县', '安龙县'],
  },
  '黑龙江': {
  ...
  '台湾': {
    ...
    '台南市': ['中西区', '东区', '南区', '北区', '安平区', '安南区', '永康区', '新营区', '仁德区'],
  },
};
