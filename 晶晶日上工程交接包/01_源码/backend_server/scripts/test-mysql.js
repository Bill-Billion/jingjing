...
const files=process.argv[2]==='providers' ? ['test/provider-foundation.test.cjs','test/provider-readiness.integration.test.cjs','test/storage.test.cjs'] : process.argv[2]==='worker' ? ['test/worker.integration.test.cjs','test/worker.test.cjs'] : ['test/mysql-config.test.cjs','test/mysql.integration.test.cjs'];
