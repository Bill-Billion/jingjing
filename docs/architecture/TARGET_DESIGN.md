...
模块职责与代码依赖见 [模块边界](../../晶晶日上工程交接包/01_源码/backend_server/src/modules/README.md)，执行/重试/兼容边界见 [持久Worker说明](../../晶晶日上工程交接包/01_源码/backend_server/docs/PERSISTENT_WORKER.md)。两项是本轮候选，正式启用与实现状态继续分别记录。
